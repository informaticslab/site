...
function displayForm($configData,$formData,$errorMessages,$itemid,$validation_result,$myuri)
{
	...
	echo '
		...
		<table width="100%" class="contentpaneopen">
		<tr>
		  <td align="right" width="20%">'.JText::_('FROM_NAME').'</td>
		  <td align="right">
		...
		<tr>
		  <td align="right" width="20%">'.JText::_('FROM_ADDRESS').'</td>
		  <td align="right">
	...
	if ($configData['subject'] == 'yes')
		echo '
			<tr>
			  <td align="right" width="20%">'.JText::_('SUBJECT').'</td>
			  <td align="right">
	...
	if ($configData['list_opt'] != 'disabled')
		...
		echo "\n".'
			<tr>
			  <td align="right" width="20%">'.$configData['list_prompt'].'</td>
			  <td align="right">
				  <select name="list1">';
	...
	if ($configData['line1_opt'] != 'disabled')
		echo "\n".'
			<tr>
			  <td align="right" width="20%">'.$configData['line1_prompt'].'</td>
			  <td align="right">
	...
	if ($configData['line2_opt'] != 'disabled')
		echo "\n".'
			<tr>
			  <td align="right" width="20%">'.$configData['line2_prompt'].'</td>
			  <td align="right">
	...
	if ($configData['line3_opt'] != 'disabled')
		echo "\n".'
			<tr>
			  <td align="right" width="20%">'.$configData['line3_prompt'].'</td>
			  <td align="right">
	...
	if ($configData['line4_opt'] != 'disabled')
		echo "\n".'
			<tr>
			  <td align="right" width="20%">'.$configData['line4_prompt'].'</td>
			  <td align="right">
	...
	if ($configData['line5_opt'] != "disabled")
		echo "\n".'
			<tr>
			  <td align="right" width="20%">'.$configData['line5_prompt'].'</td>
			  <td align="right">
	...
	if ($configData['area_opt'] != 'disabled')
		echo "\n".'
			<tr>
			  <td align="right" valign="top" width="20%">'.$configData['area_prompt'].'</td>
			  <td align="right">
	...
	if ($configData['magic_word'] != '')
		{
		echo "\n".'
			<tr><td align="right" width="20%">'.JText::_('MAGIC_WORD').'</td>
			  <td align="right">
	...
	echo "\n".'<tr><td colspan="2">';
	echo '<input class="art-button" type="submit"   name="submit1" value="'.JText::_('SEND_BUTTON').'" />';
	echo '</td></tr>';
