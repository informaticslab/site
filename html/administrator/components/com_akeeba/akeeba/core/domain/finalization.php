 ...
 * @version $Id: finalization.php 301 2010-11-17 06:52:12Z nikosdion $
 */
...
class AECoreDomainFinalization extends AEAbstractPart
{
	...
	private function apply_obsolete_quotas()
	{
		...
		$query = 'SELECT `id` FROM #__ak_stats WHERE `status` = \'complete\' AND `filesexist` = 0 ORDER BY `id` DESC LIMIT 10,100000';
		$db->setQuery($query);
