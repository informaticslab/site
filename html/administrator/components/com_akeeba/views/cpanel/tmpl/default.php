 ...
 * @version $Id: default.php 298 2010-11-15 09:46:47Z nikosdion $
 * @since 1.3
 *
...
<div style="margin: 1em; padding: 1em; background: #ffff00; border: thick solid red; color: black; font-size: 14pt;" id="notfixedperms">
	<h1 style="margin: 1em 0; color: red; font-size: 22pt;">WARNING</h1>
	<p>Akeeba Backup could not determine the permissions of the <tt>media/com_akeeba</tt> directory.</p>
	<p>Please do one of the following:</p>
	<ol>
		<li>Activate Joomla!'s FTP mode in Global Configuration</li>
		<li>Change the permissions of the <tt>media/com_akeeba</tt> directory and all of its subdirectories
			to 0755 and all of its files to 0644 using your FTP client.</li>
	</ol>
	<p>Akeeba Backup <strong><u>will most likely not work at all</u></strong> if you do not perform these steps. Do not ask for
		support if you can see this message. All the information you need is already on this message.</p>
</div>
<?php endif; ?>
