...
class SuggestionsModelvotes extends JModel
{
	var $_data;
	...
	function __construct()
	{
		...
		$this->filter_order_Dir = $mainframe->getUserStateFromRequest( $option.'vote.filter_order_Dir', 'filter_order_Dir', '', 'word' );
		$this->filter_order  = $mainframe->getUserStateFromRequest( $option.'vote.filter_order', 'filter_order',  'ordering', 'cmd' );
		$this->filter_order  = $mainframe->getUserStateFromRequest( $option.'vote.filter_order', 'filter_order',  'ordering', 'cmd' );
		...
		$limitstart = $mainframe->getUserStateFromRequest( $option.'vote.limitstart', 'limitstart', 0, 'int' );
