...
<h2>Suggest Vote Comment Bribe Installation</h2>
<table class="adminlist">
	...
	<tbody>
		<tr class="row0">
			<td class="key" colspan="2">Component: Suggest Vote Comment Bribe</td>
			<td><img src="images/publish_g.png" alt="OK" /> <strong>Installed</strong></td>
		</tr>
