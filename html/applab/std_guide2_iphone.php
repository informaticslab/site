...
<div id="download_detail_iphone"><a id="std2-applab-download" href="<?php echo $std2_manifest_link ?>"><img src="images_iphone/download_iphone.png" alt="Download app" title="Download app" name="Image4" width="65" height="20" border="0" id="Image4" /></a></div>
