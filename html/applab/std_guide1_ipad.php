...
<title>STD Guide, Version 1 | Public Health Prototypes | App Lab | Informatics R&D Lab</title>
...
<div id="first_column">
<div id="large_icon">
<img src="images/std1_large_icon.png" alt="STD Guide, Version 1" title="STD Guide, Version 1" />

</div><!--end of large_icon-->
<div id="download_detail_largest"><a id="std1-applab-download" href="itms-services://?action=download-manifest&url=http://www.phiresearchlab.org/applab/downloads/stdguide/0.4.4.001/manifest.plist" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image10','','images/download_largest_hover.png',1)"><img src="images/download_largest.png" alt="Download app" name="Image10" width="119" height="27" border="0" id="Image10" title="Download app" /></a></div><!--end of download_detail-->
<div id="stats">
...
<a href="http://code.phiresearchlab.org/viewvc/informaticslab/std-guide/">Get source code ></a>
</div><!--end of top_right_links-->

<div id="text_block">
<div id="app_name">STD Guide, Version 1</div>
...
<div id="screen_row"><img src="images/STD1_screens_row1.png" alt="STD Guidelines screenshots" title="STD Guidelines screenshots"/></div> 
<div id="screen_row2"></div> 
