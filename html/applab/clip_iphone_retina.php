...
<div id="iphone_detail_icons"><img src="images/clip_icon.png" alt="NHSN CLIP"/>
</div>



<div id="app_name_iphone">NHSN CLIP</div>

<div id="stats_iphone">
<strong>Category:</strong> Medical<br/>
    <strong>Released:</strong> <?php echo $clip_release_date ?><br/>
    <strong>Version:</strong> <?php echo $clip_version ?><br/>
    <strong>Size:</strong> <?php echo $clip_size ?><br/>
</div><!--end of stats-->
...
<div id="screen_row_iphone"><img src="images_iphone/clip_screen1.png" alt="screenshot of form, page 1" title="screenshot of form, page 1"/></div> 
<div id="screen_row_iphone"><img src="images_iphone/clip_screen2.png" alt="screenshot of form, page 2" title="screenshot of form, page 2"/></div> 
