...
<img src="images/tagline.png" title="A tool for the Lab, CDC, and its community partners to test and collaborate on innovative mobile apps" alt="A tool for the Lab, CDC, and its community partners to test and collaborate on innovative mobile apps" border="0" width="621px" height"17px" />
    ...
    <div id="first_column">
        ...
        <div id="download_detail_largest"><a id="std3-applab-download" href="<?php echo $std3_itunes_link ?>" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image10','','images/download_largest_hover.png',1)"><img src="images/download_largest.png" alt="Download app" name="Image10" width="119" height="27" border="0" id="Image10" title="Download app" /></a><br/><span class="android_inner"><a id="std3-android-applab-download" href="<?php echo $std3_google_play_link ?>">View in Google Play</a></span></div><!--end of download_detail-->
