...
<h3><?php echo CMTX_TITLE_ERROR_LOG_BACKEND ?></h3>
<hr class="title">
...
<form name="error_log_admin_panel" id="error_log_admin_panel" action="index.php?page=error_log_backend" method="post">
<textarea name="admin_errors" cols="" rows="15" style="width:100%"><?php echo $data; ?></textarea>
<p />
