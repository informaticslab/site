...
<h3><?php echo CMTX_TITLE_LIST_DUMMY_EMAILS ?></h3>
<hr class="title">
...
<form name="list_dummy_emails" id="list_dummy_emails" action="index.php?page=list_dummy_emails" method="post">
<textarea name="dummy_emails" cols="" rows="15" style="width:100%"><?php echo $data; ?></textarea>
<p />
