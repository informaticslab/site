...
<h3><?php echo CMTX_TITLE_LIST_SPAM_WORDS ?></h3>
<hr class="title">
...
<form name="list_spam_words" id="list_spam_words" action="index.php?page=list_spam_words" method="post">
<textarea name="spam_words" cols="" rows="15" style="width:100%"><?php echo $data; ?></textarea>
<p />
