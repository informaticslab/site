...
<div id="scoot">
<div id="iphone_detail_icons"><img src="images/limited_prototype_icon.png" alt="Limited prototypes icon"/>
</div>



<div id="app_name_iphone2">Mobile Testing Apps</div>

<div id="stats_iphone_2linesb">
<strong>Category:</strong> Tool-testing<br/>
<div id="stats_iphone_2linesc"><strong>Cost:</strong> Free</div>
<div id="stats_iphone_2linesc"><strong>Requirements:</strong>
iPhone, iPod Touch,</div> 
<div id="stats_iphone_2linesc">iPad with iOS 4.3 or later</div>
</div><!--end of stats-->
