...
<div id="download_detail_largest"><a id="mmwr-nav-applab-download" href="<?php $mmwr_nav_manifest_link ?>" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image11','','images/download_largest_hover.png',1)"><img src="images/download_largest.png" alt="Download app" name="Image11" width="119" height="27" border="0" id="Image11" title="Download app" /></a></div><!--end of download_detail-->
<div id="stats">
